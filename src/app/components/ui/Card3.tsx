...
export default function Card3({ children }: { children: React.ReactNode }) {
  return (
    <div
      className="relative w-full md:max-w-sm h-screen overflow-auto shadow-[0_10px_40px_rgba(0,0,0,0.6)] ring-1 ring-white/10 flex flex-col items-center justify-start p-6"
      style={{
        background: `
          ...
          radial-gradient(90% 70% at 50% 100%, #2c413a 0%, #2c413a55 35%, transparent 65%),
